...
def draw_vertical_lines_on_image(input_image_path, output_image_path, line_distance):
    ...
    for x in range(0, image_width, line_distance):
        for y in range(image_height):
            if edges[y, x] == 255 and y < max_y_coordinate:  # Check if there is an edge at this point and y < max_y_coordinate
...
output_image_path = '/home/junaidali/catkin_ws/src/hiwiifpt/flapWheel_sampledPoints_onlyFlap.jpg'  # Path to save the output image
coordinates_output_path = '/home/junaidali/catkin_ws/src/hiwiifpt/coordinates.txt'  # Path to save the coordinates of the highlighted points
...
max_y_coordinate = 610  # Maximum y-coordinate for the points to be considered
