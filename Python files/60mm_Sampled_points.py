...
def draw_vertical_lines_on_image(input_image_path, output_image_path, line_distance):
    ...
    for x in range(int(left_peak_x) + 20, int(right_peak_x) - 20, line_distance):
...
# Parameters
input_image_path = r'D:\My Files\HiWi IFPT\hiwiifpt\Images\60mm\image129.jpeg'  # Path to the input image
output_image_path = r'D:\My Files\HiWi IFPT\hiwiifpt\outputs\test_60.jpg'  # Path to save the output image
coordinates_output_path = r'D:\My Files\HiWi IFPT\hiwiifpt\outputs\coordinates_test_60.txt'  # Path to save the coordinates of the highlighted points
line_distance = 10  # Distance between vertical lines
